...
function AddDog() {
  ...
  useEffect(() => {
    const fetchFirebaseId = async () => {
      ...
      if (docSnap.exists()) {
        setFormData({
          ...formData,
          customer: { firebaseId: auth.currentUser.uid },
        })
      }
    }
    fetchFirebaseId()
  ...
  const [selectedHypoallergenic, setSelectedHypoallergenic] = useState(
    otherInfoStatuses[0].status
  )
  const [selectedCanBeLeftAone, setSelectedCanBeLeftAlone] = useState(
    otherInfoStatuses[0].status
  )
  const [selectedOkayWithCats, setSelectedOkayWithCats] = useState(
    otherInfoStatuses[0].status
  )
  const [selectedOkayWithKids, setSelectedOkayWithKids] = useState(
    otherInfoStatuses[0].status
  )
  const [selectedOkayWithDogs, setSelectedOkayWithDogs] = useState(
    otherInfoStatuses[0].status
  )
            ...
            <div className='py-6 px-4 sm:p-6 lg:pb-8'>
              <div>
                ...
                <div className='p-2'>
                  <button
                    type='button'
                    className='inline-flex rounded-md border border-transparent bg-cyan-600 px-4 py-2 text-sm text-white shadow-sm hover:bg-cyan-900 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2'
              ...
              <div className='mt-10 divide-y divide-gray-200'>
                <div className='mt-6'>
                  <div>
                    ...
                    <div className='mt-1'>
                      <input
                        ...
                        name='name'
                        id='name'
                        className='block w-full rounded-full border-gray-300 px-4 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 sm:text-sm'
                  ...
                  <div>
                    <label
                      htmlFor='dob'
                      className='ml-px block pl-4 text-sm font-medium text-gray-700 pt-3'
                    >
                      Dogs Date of Birth
                    </label>
                    <div className='mt-1'>
                ...
                <div className='p-5'>
                  <button
                    type='button'
                    className='inline-flex  float-right rounded-md border border-transparent bg-cyan-600 px-4 py-2 text-base font-small text-white shadow-sm hover:bg-cyan-900 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2'
                    onClick={onSubmit}
                  >
                  ...
                  <button
                    type='button'
                    className='inline-flex  float-left rounded-md border border-transparent bg-cyan-600 px-4 py-2 text-base font-small text-white shadow-sm hover:bg-cyan-900 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2'
