            ...
            <div className='flex'>
              ...
              <div className='ml-3'>
                <p className='text-sm text-yellow-700'>
                  Please note that this website is a capstone project currently
                  in development by 4 CodeClan students. All profiles and dogs
                  are ficticious.
                  <a
                    href='/about'
            ...
            <main className='mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
              <div className='sm:text-center lg:text-left'>
                ...
                <p className='mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0'>
                  Helping connect dog owners who are office or hybrid working
                  with woofers who can look after their dog
                </p>
                {!currentUser ? (
        ...
        <div className='relative mx-auto max-w-7xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16'>
          <div className='mx-auto max-w-2xl lg:mr-0 lg:ml-auto lg:w-1/2 lg:max-w-none lg:pl-10'>
            ...
            <p className='mt-6 text-lg text-gray-500'>
              After filling in our registration form, our complex algorithm will
              match you to users who can assist and look after your dog when you
              are in the office. Working from home some days of the week? Then
              we will match you with users with dogs who you could assist.
            </p>
            ...
            <blockquote className='mt-6 md:flex md:flex-grow md:flex-col'>
              <div className='relative text-lg font-medium text-white md:flex-grow'>
                ...
                <p className='relative'>
                  Thank's to Woofing From Home I am saving over £300 a month on
                  dog sitting costs. This app has been a lifesaver during the
                  financial crisis. My dog Mable loves her new routine of
                  visting her fellow Woofers.
                </p>
              </div>
          ...
          <div className='border-t-2 border-cyan-900 py-12 px-4 sm:px-6 md:border-t-0 md:border-l md:py-16 md:pr-0 md:pl-10 lg:pl-16'>
            ...
            <blockquote className='mt-6 md:flex md:flex-grow md:flex-col'>
              <div className='relative text-lg font-medium text-white md:flex-grow'>
                ...
                <p className='relative'>
                  I Woof from Home 5 days a week but can't commit to owning my
                  own dog. I love being able to help dog owners out and
                  currently have 3 dogs that visit me weekly.
                </p>
              </div>
              <footer className='mt-8'>
                <div className='flex items-start'>
