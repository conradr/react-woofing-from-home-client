          ...
          <>
                          ...
                          <div>
                            {currentUser ? (
                              ...
                              <>
                                <button
                                  type='button'
                                  className='inline-flex items-center rounded border border-transparent bg-cyan-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2'
                                  onClick={onSignup}
                                >
                                  Sign up
                                </button>
                                <button
                                  type='button'
                                  className='inline-flex mx-2 items-center rounded border border-transparent bg-rose-500 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2'
                                  onClick={onSignin}
                                >
                                  Sign in
                                </button>
            ...
            <Disclosure.Panel className='border-b border-gray-700 md:hidden'>
              ...
              {currentUser ? (
                ...
                <button
                  type='button'
                  className='rounded border border-transparent bg-cyan-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 mx-4'
                  onClick={onSignin}
                >
                  Sign in
                </button>
